...
const measureText = (text, style, maxWidth) => {
  ...
  const baseWidth =
    context.measureText(text).width + text.length * style.letterSpacing;
  ...
  words.forEach((word) => {
    ...
    const testWidth =
      ...
      testLine.length * style.letterSpacing;
  ...
  return (
    <div className="flex items-center space-x-2 p-2">
      ...
      <input
        ...
        onChange={(e) =>
          onStyleChange("fontSize", pointsToPixels(parseInt(e.target.value)))
        }
      ...
      <div className="flex border rounded">
        <Button
          ...
          className={
            selectedElement.style.align === "left" ? "bg-gray-200" : ""
          }
        >
        ...
        <Button
          ...
          className={
            selectedElement.style.align === "center" ? "bg-gray-200" : ""
          }
        >
        ...
        <Button
          ...
          className={
            selectedElement.style.align === "right" ? "bg-gray-200" : ""
          }
        >
        ...
        <Button
          ...
          className={
            selectedElement.style.align === "justify" ? "bg-gray-200" : ""
          }
        >
      ...
      <div className="flex items-center space-x-2 border rounded px-2">
        ...
        <input
          ...
          onChange={(e) =>
            onStyleChange("letterSpacing", parseInt(e.target.value))
          }
          className="w-16 h-9 border rounded px-2"
          min="-2"
          max="20"
      ...
      slide.textElements.forEach((element) => {
        const textOptions = {
          ...
          paraSpaceAfter: element.style.lineHeight
            ? (element.style.lineHeight - 1) * 100
            : 0,
          charSpacing: element.style.letterSpacing
            ? element.style.letterSpacing * 100
            : 0,
        };
        ...
        if (element.style.textTransform) {
          switch (element.style.textTransform) {
            ...
            case "lowercase":
              ...
              break;
            case "capitalize":
              textContent = textContent.replace(/\b\w/g, (l) =>
                l.toUpperCase()
              );
              break;
          }
...
const SlideEditor = () => {
  ...
  const handleAddImage = async (event) => {
    ...
    reader.onload = async (e) => {
      ...
      img.onload = () => {
        ...
        updateSlideElements(activeSlide, textElements, [
          ...imageElements,
          newElement,
        ]);
        setSelectedElement(newElement.id);
  ...
  const handleDelete = () => {
    ...
    const updatedImageElements = imageElements.filter(
      (el) => el.id !== selectedElement
    );

    updateSlideElements(activeSlide, updatedTextElements, updatedImageElements);
